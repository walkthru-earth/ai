...
export const DATASETS: DatasetInfo[] = [
  {
    ...
    description:
      "NOAA GraphCast AI weather forecasts. Temperature, wind (10m & 850hPa), wind shear, humidity, moisture flux, pressure, precipitation, geopotential. Hours 0 and 12. Res 0-5.",
    columns: [
      "h3_index",
      "timestamp",
      "temperature_2m_C",
...
const COLUMN_DESCRIPTIONS: Record<string, string> = {
  ...
  wind_shear_direction_deg: "Wind shear direction (degrees)",
  wind_u_10m_ms: "U-component (eastward) of wind at 10m (m/s)",
  wind_v_10m_ms: "V-component (northward) of wind at 10m (m/s)",
