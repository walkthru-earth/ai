...
export const weatherDataset: DatasetDefinition = {
  ...
  columnTypes: {
    ...
    temperature_850hPa_C: "FLOAT",
    temp_diff_850hPa_2m_C: "FLOAT",
    wind_speed_10m_ms: "FLOAT",
    wind_direction_10m_deg: "FLOAT",
    wind_speed_850hPa_ms: "FLOAT",
    wind_direction_850hPa_deg: "FLOAT",
    wind_u_10m_ms: "FLOAT",
    wind_v_10m_ms: "FLOAT",
    wind_u_850hPa_ms: "FLOAT",
    wind_v_850hPa_ms: "FLOAT",
    wind_shear_magnitude_ms: "FLOAT",
    wind_shear_direction_deg: "FLOAT",
    specific_humidity_gkg: "FLOAT",
    moisture_flux_u: "FLOAT",
    moisture_flux_v: "FLOAT",
    moisture_flux_magnitude: "FLOAT",
    pressure_msl_hPa: "FLOAT",
    precipitation_mm_6hr: "FLOAT",
    vertical_velocity_500hPa_Pas: "FLOAT",
    geopotential_500hPa_m: "FLOAT",
    geopotential_anomaly_500hPa_m: "FLOAT",
  },
